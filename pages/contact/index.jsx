...
const schema = yup.object().shape({
  fullName: yup
    ...
    .matches(fullNameRegex, "Field is invalid."),
  email: yup
    .string()
    .required("Field is required.")
    .matches(emailRegex, "Field is invalid."),
      ...
      <div className="container mx-auto max-h-[calc(100vh-14rem)] sm:max-h-none overflow-y-auto sm:py-32 text-center xl:text-left sm:flex items-center justify-center">
        <div className="flex flex-col w-full max-w-[700px]">
          ...
          >
            ...
            <a
              href="mailto:berkaybideci@gmail.com"
              className="underline font-medium"
            >
              berkaybideci@gmail.com
            </a>{" "}
          ...
          >
            ...
            <button
              type="submit"
              className="btn rounded-full border border-black/60 dark:border-white/20 max-w-[170px] px-8 transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-accentLight dark:hover:border-accent group relative"
            >
