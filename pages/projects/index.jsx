...
const Projects = () => {
    return (
        <div className="h-full dark:bg-primary/30 bg-gradient-to-r dark:bg-none from-primaryLight via-primaryLight/60 to-primaryLight/10 bg-primaryLight/60 overflow-y-auto xl:overflow-hidden">
            <Header />
