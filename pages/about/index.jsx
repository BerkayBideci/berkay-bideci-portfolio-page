      ...
      <div className="container mx-auto max-h-[calc(100vh-14rem)] sm:max-h-none overflow-y-auto sm:flex flex-col items-center justify-center xl:flex-row gap-x-6">
        <div className="xl:flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Impressive designs are <br /> born from unique{" "}
            <span className="text-accentLight dark:text-accent">stories</span>
          </motion.h2>
          <motion.p
          ...
          >
            <strong className="font-bold">
              My voyage to the tech industry is rather unconventional.
            </strong>{" "}
            After earning a degree from the Department of Russian Language and
            Literature at Ankara University and gaining experience as a
            translator on various projects, both volunteer and professional,{" "}
            <strong className="font-bold">
              I reached a pivotal crossroads in my life.
            </strong>{" "}
            Fueled by my dreams, I co-founded a startup with my friends, focused
            on tabletop role-playing games. But it was the crafting of our
            official website that unveiled a new passion lying dormant within
            me.{" "}
            <strong className="font-bold">
              It was a revelation — a beacon guiding me to the vibrant shores of
              Front-End Web Development,
            </strong>{" "}
            where every line of code weaves a story just waiting to be told.
          </motion.p>
          <motion.div
              ...
              if (item.title !== "Resume") {
                return (
                  <div
                    ...
                    className={`
                    ${index === itemIndex &&
                      "dark:text-accent text-accentLight after:w-[100%] after:bg-accentLight dark:after:bg-accent after:transition-all after:duration-300"
                      } cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] after:bg-white after:absolute after:-bottom-1 after:left-0 hidden xl:flex`}
            ...
            {aboutData[index].info.map((item, itemIndex) => {
              if (item.title === "") {
                return (
                  ...
                  >
                    <span className="group-hover:-translate-y-[120%] group-hover:opacity-0 transition-all duration-500 text-black dark:text-white">
                      Download Resume
                    </span>
                ...
                return (
                  <div
                    key={itemIndex}
                    className="xl:flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center justify-center text-black/60 dark:text-white/60"
                  >
                    ...
                    <div className="flex flex-wrap gap-4 max-w-xs">
                      {item.technologies?.map((tech, itemIndex) => {
                        return (
                          ...
                          >
                            <div className="text-2xl mb-1 hover:text-accentLight dark:hover:text-accent">
                              {tech.icon}
                            </div>
