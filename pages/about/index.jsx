...
const About = () => {
    ...
    return (
        <div className="h-full bg-gradient-to-r dark:bg-none from-primaryLight via-primaryLight/60 to-primaryLight/10 bg-primaryLight/60 dark:bg-primary/30 text-center xl:text-left overflow-y-auto xl:overflow-hidden">
            <Header />
            <div className="h-4/5 flex justify-center items-center xl:mt-16">
                <Circles />
                <motion.div
                ...
                <div className="container mx-auto h-full flex flex-col items-center justify-center sm:justify-start xl:flex-row gap-x-6">
                    ...
                    <motion.div
                        ...
                        animate="show"
                        exit="hidden"
                        className="flex flex-col w-full xl:max-w-[48%] sm:h-[530px]">
